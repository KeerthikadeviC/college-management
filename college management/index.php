...
<body>
	<div class="container">
    	...
    	<div class="container2">
    		...
    		<input type="submit" href="#" class="btn btn-default" name="btn_log" value="Next" style="float: right;"/>
    		<div class="about_pos">
                    <a href="AboutManagement.php" style="text-decoration:none; color: silver"> </a>
    		</div>
    		</form>
    	</div>
    </div>
