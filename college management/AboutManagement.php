...
<html>
    <head>
        ...
        <title>This project is develope by Geetha S V,Gowthami T,Jayapriya R,Keerthikadevi C</title>
    </head>
    <body>
        <div class="panel panel-default">
			...
			<div class="container">
				<p style="text-align:center;">Project</p>
                        ...
                        <h1><strong>Made by: </strong>Geetha S V,Gowthami T,Jayapriya R,Keerthikadevi C</h1>
                        <h1><strong>College: </strong>UCE-BIT Campus,Anna University,Tiruchirappalli</h1>
